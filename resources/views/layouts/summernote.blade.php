 <script src="{{ url('rapido/assets/plugins/jQuery/jquery-2.1.1.min.js') }}"></script>
    ...
    <script src="{{ url('rapido/assets/plugins/DataTables/media/js/DT_bootstrap.js') }}"></script>
    ...
    <script src="{{ url('rapido/assets/plugins/ckeditor/ckeditor.js') }}"></script>
    <script src="{{ url('rapido/assets/plugins/ckeditor/adapters/jquery.js') }}"></script>
    <script src="{{ url('rapido/assets/js/form-validation.js') }}"></script>
